...
## Licenza
O código fonte publícase so unha [licenza libre GPL v3.0](https://www.gnu.org/licenses/gpl.html). É un programa de acceso libre, descargable e editable desde o seguinte [repositorio github](https://github.com/ppillot/libmol)

## Agradecementos
### Contribucións
- Hervé Furstoss (documentación incrustada)
- Philippe Cosentino, Sandrine Beaudin, Eric Jourdan, Valérie Rambaud,  Jacques Janin, Frédéric Labaune, Sandra Rodot, Sébastien Gruszka, Nazim Sellal, David Bard, Mélanie Fenaert polos eus moitos tests e suxestións
...
-Xaime M González Ortega pola tradución ao galego.
...
### Bibliotecas
LibMol está baseado en varias valiosas bibliotecas o servizos de acceso aberto.
- [NGL](https://github.com/arose/ngl) para a visualización 3D de modelos moleculares
  ...
  - AS Rose and PW Hildebrand. _NGL Viewer: a web application for molecular visualization._ Nucl Acids Res (1 July 2015) 43 (W1): W576-W579 publicada por primeira vez en liña o 29 de April de 2015. [doi:10.1093/nar/gkv402](https://doi.org/10.1093/nar/gkv402)
- [Vue.js](https://vuejs.org/) e o seu ecosistema para a infraestrutura do programa
- [Vuei18n](https://github.com/kazupon/vue-i18n): i18n plugin
- [ElementUI](http://element.eleme.io/#/en-US): esquema de interface de usuario
